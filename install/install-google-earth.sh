...
## Mac Radigan
  ...
  apt-get install -y libglib2.0-0:i-386
  apt-get install -y libglu1-mesa:1386
  apt-get install -y libglu1-mesa-glx:1386
  apt-get install -y libext6:i386
  apt-get install -y librender1:i386
  apt-get install -y libx11-6:i386
  apt-get install -y libconfig1-6:i386
